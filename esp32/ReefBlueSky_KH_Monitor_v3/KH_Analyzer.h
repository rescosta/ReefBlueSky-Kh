...
private:
    ...
    enum Phase1State {
        F1_IDLE,
        F1_DRAIN_R2_TO_R1,   // esvaziar R2 -> R1
        F1_DRAIN_R1_TO_TANK, // esvaziar R1 -> aquário
        F1_DONE
    };

    Phase1State _phase1_state = F1_IDLE;
    unsigned long _phase1_step_start_ms = 0;
    unsigned long _phase1_r2_max_ms     = 10000; // ex.: 10s para R2->R1
    unsigned long _phase1_r1_max_ms     = 10000; // ex.: 10s para R1->Aquário
    ...
    unsigned long _phase2_fill_max_ms   = 10000; // tempo máximo R2->R3
    ...
    Phase3State _phase3_state = F3_IDLE;
    unsigned long _phase3_start_ms = 0;
    unsigned long _phase3_max_ms   = 15000; // ex.: 15s de coleta, ajuste depois
